...
const SignupStaff = () => {
	...
	return (
		<div className='h-[100vh]'>
			<div className='absolute top-[130px] right-[50px] left-[300px] max-[800px]:left-[50px] bottom-[50px] max-[800px]:border-none border-[1px] border-black rounded flex justify-center items-center'>
								...
								{inputSignup.map((s, i) => {
									return (i != 4) ? <>
										<input type={s.placeholder == 'Email' ? 'email' : 'text'} placeholder={s.placeholder}
											...
											className='w-full px-[10px] py-[5px] mb-[10px] rounded focus:outline-none bg-white text-black max-[800px]:border-b-2 md:border-2 border-gray'
										/> <br />
									</> : null
								})}
