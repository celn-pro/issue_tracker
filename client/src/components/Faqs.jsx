  ...
  return (
       ...
       <div>
          ...
          <div className='mb-[20px]'>
            <h3 className='font-system font-bold max-800:text-[12px] font-medium'>
            ...
            <p className={`${showFaq?'block':'hidden'} font-verdan rounded max-800:text-[12px] border-[1px] py-[10px] px-[10px]`}>
              {faq.description} 
