...
const Main = () => {
  ...
  return (
	<div className=' ml-[300px] max-800:ml-[50px]'>
	  <div className='border-[1px] border-black right-[50px] left-[300px] max-800:left-[50px]  top-[130px] bottom-[50px] absolute rounded overflow-auto px-[20px] flex justify-center items-center'>
        ...
        <div className=' mt-[10px] relative flex justify-center items-center mb-[30px]'>
            <div className=''>
				<div className='mb-[10px] max-800:hidden'>
