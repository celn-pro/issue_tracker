...
const SideBar = () => {
  ...
  return (
	...
	<div className='bg-gray-200 hidden max-[800px]:block absolute left-0 z-30'>
		{open?<div className='w-[30px] h-[30px] flex justify-center items-center' onClick={()=>setOpen(!open)}>
			<div>x</div>
		</div>:
