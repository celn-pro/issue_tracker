...
const Profile = (props) => {
	...
	const handleOnChange = async(e)=>{
		...
		if(file){
			...
			const response = await fetch('http://localhost:3000/profileImg', {
				method: 'POST',
				body: formData,
  ...
  return (
	  <div className='h-[100vh] ml-[300px] max-[800px]:ml-0'>
		<div className=' absolute bottom-[50px] top-[50px] right-[50px] left-[350px] max-[800px]:left-[50px] rounded flex justify-center items-center'>
			<div className='w-[340px] px-[20px] py-[20px] shadow-xl rounded-xl'>
				<div className='flex justify-center items-center h-[300px] rounded'>
					...
					<div className='h-[200px] w-[200px] bg-gray-200 rounded-[50%] overflow-hidden'>
						...
						<div className='absolute bg-red-100 max-[800px]:right-[40%] right-[490px] top-[360px] h-[30px] w-[30px] rounded-[50%] px-[7px] py-[5px] flex justify-center items-center cursor-pointer'
							 onClick={handleClick}
						>
