					...
					<div className='font-bold'>
						<form onSubmit={handleSubmit}>
						  ...
						  <div>
							  ...
							  <div>New name:
								  <input type="text" placeholder={userData.password} className='md:w-[400px] max-[800]:w-full ml-[20px] max-800:ml-0 enabled outline-none px-[10px] py-[10px] border-[1px] rounded text-green-500 font-bold' onChange={(e)=>{
										setData((prevData) => {
										const newData = [...prevData]
