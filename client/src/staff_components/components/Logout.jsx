...
const Logout = (props) => {
  ...
  return (
	  <div className='h-[100vh] ml-[300px] max-[800px]:ml-0'>
		  <div className=' bottom-[50px] rounded top-[50px] right-[50px] left-[350px] max-[800px]:left-[50px] absolute max-[800px]:border-none border-[1px] py-[20px] px-[20px]'>
			<div className='flex justify-center items-center w-full h-full'>
				<div className='border-[1px] w-[200px] px-[20px] py-[20px]'>
					<div>⚠ Loging out</div>
					<div className='flex gap-3 font-bold text-white'>
						<button className='bg-green-600 rounded px-[10px] py-[5px]' onClick={()=>toggleSelectedAdminSideBar('WorkBoard')}>Cancel</button>
